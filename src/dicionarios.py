...
def exercicio_01():
    aluno: Dict[str, Union[str, int, bool]] = {
        "nome_completo": "Lucas Vinícius Benevenutti",
        "nome_mae": "Bernadete Benevenutti",
        "nome_pai": "Geraldo Emanuel da Silva",
        "jogar": True
    }

    print(f"""
Aluno: {aluno.get("nome_completo")}
Mãe: {aluno.get("nome_mae")}
Pai: {aluno.get("nome_pai")}
        """)
